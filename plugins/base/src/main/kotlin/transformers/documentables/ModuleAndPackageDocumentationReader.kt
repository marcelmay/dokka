...
import org.jetbrains.dokka.plugability.querySingleOrNull
...
private class ContextModuleAndPackageDocumentationReader(
    ...
    private val kotlinAnalysis: KotlinAnalysis? = context.plugin<DokkaBase>().querySingleOrNull { kotlinAnalysis }
